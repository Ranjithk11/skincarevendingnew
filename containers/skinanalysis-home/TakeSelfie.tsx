...
// MediaPipe camera kept for future (USE_MEDIAPIPE_FACE_SCAN) — not used in legacy TakeSelfie:
...
const TakeSelfie = () => {
  ...
  return (
    <PageBackground showGreenCurve>
      ...
      {/* Legacy ARCamera (face-api). MediaPipe LiveSkinScanCamera kept for future flag. */}
      {openCamera && (
        <ARCameraComponent
          autoStart={true}
